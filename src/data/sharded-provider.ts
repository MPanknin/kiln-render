/**
 * ShardedDataProvider - DataProvider implementation for Kiln's native sharded format
 *
 * Loads volume data from the binary sharded format generated by decompose-volume.ts:
 * - volume.json: Volume metadata
 * - lodN.bin: Binary brick data files
 * - lodN_index.json: Index files with byte offsets and statistics
 *
 * Features:
 * - HTTP Range requests for efficient brick loading
 * - Gzip decompression via worker pool
